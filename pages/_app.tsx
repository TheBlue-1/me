import "custom-scroll-behaviors/frameworks/react-declarations";
  ...
  return (
    <div>
      <Head>
        ...
        <meta name="audience" lang="DE-AT" content="Software Developer, Maximilian, Mayrhofer, Website" />
        <meta name="copyright" content="Maximilian Mayrhofer 2020" />
        <meta property="og:title" content="Maximilian Mayrhofer - Software Developer" />
        <meta property="og:url" content="/" />
        <meta
          property="og:description"
          content="Hire me if you need a Developer! Invite me if you make a Party! Visit my site if you are curious!"
        />
        <meta name="keywords" content="Software Developer, Maximilian, Mayrhofer, Website" />
        <meta
          name="description"
          content="Hire me if you need a Developer! Invite me if you make a Party! Visit my site if you are curious!"
        />
